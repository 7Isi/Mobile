      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 20,),
            Text("Eixo X: ${_acelerometroValues![0].toStringAsFixed(1)}}"),
            Text("Eixo Y: ${_acelerometroValues![1].toStringAsFixed(1)}}"),
            Text("Eixo Z: ${_acelerometroValues![2].toStringAsFixed(1)}"),
          ],
        ),
      ),
    );
