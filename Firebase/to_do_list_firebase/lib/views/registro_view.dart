...
class RegistroView extends StatefulWidget {
  ...
  @override
  State<RegistroView> createState() => _ResgistroViewState();
}

class _ResgistroViewState extends State<RegistroView> {
  ...
  void _registrar() async{
    try {
      ...
      //ao criar usuário, é logado eutomaticamente para a tela de tarefas
    } catch (e) {
