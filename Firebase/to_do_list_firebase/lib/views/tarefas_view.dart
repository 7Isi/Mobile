...
class _TarefasViewState extends State<TarefasView> {
  ...
  final _tarefasField = TextEditingController(); //campo para pegar o titulo da tarefa
    ...
    return Scaffold(
      ...
      child: Column(
        children: [
          ...
          SizedBox(height: 16,),
          Expanded(
            child: StreamBuilder<QuerySnapshot>( // dependendo do resultado da Querry (consulta no bd) exibe a tela desejada
              ...
              builder: (context, snapshot){
                ...
                return ListView.builder(
                  ...
                  itemBuilder: (context, index){
                    ...
                    //ajuste da variavel booleana
                    bool concluida = tarefaMap["concluida"] == true ? true : false; // ou pode ser
